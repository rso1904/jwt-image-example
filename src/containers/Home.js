...
class Home extends React.Component {
    ...
    loadNewMemo() {
      ...
      if (this.props.memoData.length === 0)
          return this.props.memoListRequest(true, undefined, undefined, this.props.username, this.props.token);

      return this.props.memoListRequest(false, 'new', this.props.memoData[0]._id, this.props.username, this.props.token);
    }
    ...
    loadOldMemo() {
      ...
      // START REQUEST
      return this.props.memoListRequest(false, 'old', lastId, this.props.username, this.props.token).then(() => {
        ...
        this.props.memoRemoveRequest(id, index).then(() => {
            if (this.props.removeStatus.status === "SUCCESS") {
                ...
                */
                ...
                // NOTIFY ERROR
                let $toastContent = $('<span sytle="color: #FFB4BA">' + errorMessage[this.props.removeStatus.error - 1] + '</span>');
                Materialize.toast($toastContent, 2000);

                // IF NOT LOGGED IN, REFERESH THE PAGE
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        memoListRequest: (isInitial, listType, id, username, token) => {
            return dispatch(memoListRequest(isInitial, listType, id, username, token));
        },
